...
Run this on your **live** store data in one prompt: connect Shopify, ads, analytics, email/SMS, and finance with [ShopMCP](https://my.shop-mcp.app/playbooks/email-winback-builder) — it executes this play read-only by default and applies changes only on your approval.
