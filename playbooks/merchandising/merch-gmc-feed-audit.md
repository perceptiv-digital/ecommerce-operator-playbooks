...
Which feed issues are blocking product visibility or trust?
...
- Also useful for: Merchandising Manager, Performance Marketer
...
1. Define the decision window and write the operating question: "Which feed issues are blocking product visibility or trust?"
...
```text
You are helping me run the "GMC Feed Audit" ecommerce operating play.
...
https://my.shop-mcp.app/playbooks/merch-gmc-feed-audit?utm_source=github&utm_medium=playbook&utm_campaign=ecommerce_operator_os
