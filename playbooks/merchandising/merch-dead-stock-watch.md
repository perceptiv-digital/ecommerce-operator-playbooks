...
Which products are tying up cash without enough demand?
...
- Also useful for: Merchandising Manager, Founder / CEO, Ops / Dispatch Lead
...
1. Define the decision window and write the operating question: "Which products are tying up cash without enough demand?"
...
```text
You are helping me run the "Dead Stock Watch" ecommerce operating play.
