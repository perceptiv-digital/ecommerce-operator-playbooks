...
What is materially different versus the same period last year?
...
1. Define the decision window and write the operating question: "What is materially different versus the same period last year?"
...
```text
You are helping me run the "Year-over-Year Pulse" ecommerce operating play.
