...
Do we have enough cost evidence to answer profit questions safely?
...
1. Define the decision window and write the operating question: "Do we have enough cost evidence to answer profit questions safely?"
...
```text
You are helping me run the "Profit Readiness Audit" ecommerce operating play.
