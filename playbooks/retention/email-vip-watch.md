...
Are VIP customers becoming less active or less valuable?
...
- Also useful for: Retention / Email Lead, Founder / CEO
...
1. Define the decision window and write the operating question: "Are VIP customers becoming less active or less valuable?"
...
```text
You are helping me run the "VIP Cohort Watch" ecommerce operating play.
