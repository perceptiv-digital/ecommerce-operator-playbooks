...
What changed in email and retention last week?
...
- Also useful for: Retention / Email Lead, Head of Marketing
...
1. Define the decision window and write the operating question: "What changed in email and retention last week?"
...
```text
You are helping me run the "Email Monday Recap" ecommerce operating play.
