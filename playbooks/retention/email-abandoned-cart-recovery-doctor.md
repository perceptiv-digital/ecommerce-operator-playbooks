...
Is abandoned-cart recovery leaving money behind?
...
- Also useful for: Retention / Email Lead, Head of Ecommerce
...
1. Define the decision window and write the operating question: "Is abandoned-cart recovery leaving money behind?"
...
```text
You are helping me run the "Abandoned Cart Recovery Doctor" ecommerce operating play.
...
https://my.shop-mcp.app/playbooks/email-abandoned-cart-recovery-doctor?utm_source=github&utm_medium=playbook&utm_campaign=ecommerce_operator_os
