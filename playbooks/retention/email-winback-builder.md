...
Which dormant customers are worth trying to win back?
...
1. Define the decision window and write the operating question: "Which dormant customers are worth trying to win back?"
...
```text
You are helping me run the "Winback Builder" ecommerce operating play.
...
https://my.shop-mcp.app/playbooks/email-winback-builder?utm_source=github&utm_medium=playbook&utm_campaign=ecommerce_operator_os
