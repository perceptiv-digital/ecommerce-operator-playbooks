...
When should replenishment messages be sent by product or category?
...
- Also useful for: Retention / Email Lead, Merchandising Manager
...
1. Define the decision window and write the operating question: "When should replenishment messages be sent by product or category?"
...
```text
You are helping me run the "Replenishment Timing" ecommerce operating play.
...
https://my.shop-mcp.app/playbooks/email-replenishment-timing?utm_source=github&utm_medium=playbook&utm_campaign=ecommerce_operator_os
