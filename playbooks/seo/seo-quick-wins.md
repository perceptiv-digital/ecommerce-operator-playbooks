...
summary: "SEO Quick Wins helps ecommerce operators answer: Which organic search wins are close enough to act on now?"
operating_question: "Which organic search wins are close enough to act on now?"
short_title: "SEO Quick Wins"
primary_persona: "seo"
personas: ["seo"]
...
Which organic search wins are close enough to act on now?
...
1. Define the decision window and write the operating question: "Which organic search wins are close enough to act on now?"
...
```text
You are helping me run the "SEO Quick Wins" ecommerce operating play.
...
https://my.shop-mcp.app/playbooks/seo-quick-wins?utm_source=github&utm_medium=playbook&utm_campaign=ecommerce_operator_os
