...
Which pages are losing demand and are worth refreshing?
...
- Also useful for: SEO / Content Lead, Head of Marketing
...
1. Define the decision window and write the operating question: "Which pages are losing demand and are worth refreshing?"
...
```text
You are helping me run the "SEO Content Decay Watch" ecommerce operating play.
...
```text
Run the SEO Content Decay Watch play for the last 30 days. Keep it read-only.
```
