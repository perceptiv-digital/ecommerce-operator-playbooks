...
summary: "Schema and Rich Result Readiness helps ecommerce operators answer: Which structured-data gaps block ecommerce search trust?"
operating_question: "Which structured-data gaps block ecommerce search trust?"
short_title: "Schema and Rich Result Readiness"
primary_persona: "seo"
...
shopmcp_run_url: "https://my.shop-mcp.app/playbooks/seo-schema-rich-result-readiness"
shopmcp_prompt: "Run the Schema and Rich Result Readiness play for the last 30 days. Keep it read-only."
...
Which structured-data gaps block ecommerce search trust?
...
- Also useful for: SEO / Content Lead, Head of Ecommerce, Head of Marketing
...
- SERP, keyword, competitor, page, or structured-data evidence from DataForSEO.
...
1. Define the decision window and write the operating question: "Which structured-data gaps block ecommerce search trust?"
...
```text
You are helping me run the "Schema and Rich Result Readiness" ecommerce operating play.
