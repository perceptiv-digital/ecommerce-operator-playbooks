...
summary: "SEO Cannibalisation Audit helps ecommerce operators answer: Which pages compete with each other for the same search demand?"
operating_question: "Which pages compete with each other for the same search demand?"
short_title: "SEO Cannibalisation"
primary_persona: "seo"
personas: ["seo"]
...
shopmcp_run_url: "https://my.shop-mcp.app/playbooks/seo-cannibalisation-audit"
shopmcp_prompt: "Run the SEO Cannibalisation Audit play for the last 30 days. Keep it read-only."
...
Which pages compete with each other for the same search demand?

This play helps seo / content lead make a defensible ecommerce operating decision. It is not a generic prompt. It is a repeatable workflow that forces evidence, thresholds, and vetoes before action.

## Who Should Run It

- Primary owner: SEO / Content Lead
- Also useful for: SEO / Content Lead
- Best used when the owner needs a decision, not just a report.

## When To Run It

- Cadence: monthly
- Run it when the owner needs to decide: where can organic or search demand be recovered?
- Use it before changing budgets, creative, product data, lifecycle flows, stock priorities, or client commentary.

## Required Evidence

- Google Search Console query, page, click, impression, CTR, and position evidence.
...
1. Define the decision window and write the operating question: "Which pages compete with each other for the same search demand?"
...
4. Use search evidence first, layer commerce value where available, then rank by recoverability instead of generic traffic volume.
...
```text
You are helping me run the "SEO Cannibalisation Audit" ecommerce operating play.
...
https://my.shop-mcp.app/playbooks/seo-cannibalisation-audit?utm_source=github&utm_medium=playbook&utm_campaign=ecommerce_operator_os
