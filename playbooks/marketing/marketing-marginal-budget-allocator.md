...
summary: "Marginal Budget Allocator helps ecommerce operators answer: Where should the next marginal dollar go?"
operating_question: "Where should the next marginal dollar go?"
short_title: "Marginal Budget Allocator"
...
shopmcp_run_url: "https://my.shop-mcp.app/playbooks/marketing-marginal-budget-allocator"
shopmcp_prompt: "Run the Marginal Budget Allocator play for the last 30 days. Keep it read-only."
...
Where should the next marginal dollar go?
...
- Also useful for: Head of Marketing, Founder / CEO, Performance Marketer
...
1. Define the decision window and write the operating question: "Where should the next marginal dollar go?"
...
```text
You are helping me run the "Marginal Budget Allocator" ecommerce operating play.
