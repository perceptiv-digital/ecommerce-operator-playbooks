...
Which competitor demand signals deserve a response?

This play helps head of marketing make a defensible ecommerce operating decision. It is not a generic prompt. It is a repeatable workflow that forces evidence, thresholds, and vetoes before action.

## Who Should Run It

- Primary owner: Head of Marketing
- Also useful for: Head of Marketing, SEO / Content Lead, Performance Marketer
...
1. Define the decision window and write the operating question: "Which competitor demand signals deserve a response?"
...
```text
You are helping me run the "Competitor Demand Brief" ecommerce operating play.
