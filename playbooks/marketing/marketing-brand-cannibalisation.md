...
Are paid campaigns buying demand that organic search would have captured?
...
- Also useful for: Head of Marketing, Performance Marketer
...
1. Define the decision window and write the operating question: "Are paid campaigns buying demand that organic search would have captured?"
...
```text
You are helping me run the "Brand Cannibalisation Audit" ecommerce operating play.
