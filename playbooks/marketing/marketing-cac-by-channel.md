...
Which channels are acquiring new customers at acceptable cost?
...
1. Define the decision window and write the operating question: "Which channels are acquiring new customers at acceptable cost?"
...
```text
You are helping me run the "New-Customer CAC by Channel" ecommerce operating play.
