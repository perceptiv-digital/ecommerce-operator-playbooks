...
shopmcp_run_url: "https://my.shop-mcp.app/playbooks/ops-dispute-evidence"
...
What evidence is needed to respond to this dispute safely?
...
- Stripe payment, charge, payout, invoice, dispute, or subscription evidence.
...
1. Define the decision window and write the operating question: "What evidence is needed to respond to this dispute safely?"
...
```text
You are helping me run the "Stripe Dispute Evidence Pack" ecommerce operating play.
