...
Which stockouts are costing the most demand or revenue?
...
- Also useful for: Head of Ecommerce, Merchandising Manager, Ops / Dispatch Lead
...
1. Define the decision window and write the operating question: "Which stockouts are costing the most demand or revenue?"
...
```text
You are helping me run the "Stockout Lost-Revenue Impact" ecommerce operating play.
