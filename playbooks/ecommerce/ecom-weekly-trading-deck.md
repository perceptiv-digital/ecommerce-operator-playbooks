...
shopmcp_run_url: "https://my.shop-mcp.app/playbooks/ecom-weekly-trading-deck"
...
What happened this week, why, and what should the operator do next?
...
- Also useful for: Head of Ecommerce, Founder / CEO
...
1. Define the decision window and write the operating question: "What happened this week, why, and what should the operator do next?"
...
```text
You are helping me run the "Weekly Trading Deck" ecommerce operating play.
...
https://my.shop-mcp.app/playbooks/ecom-weekly-trading-deck?utm_source=github&utm_medium=playbook&utm_campaign=ecommerce_operator_os
