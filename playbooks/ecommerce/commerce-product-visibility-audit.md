...
Which products are invisible across commerce, search, and feed surfaces?
...
- Also useful for: Head of Ecommerce, Merchandising Manager, SEO / Content Lead, Agency AM / COO
...
1. Define the decision window and write the operating question: "Which products are invisible across commerce, search, and feed surfaces?"
...
```text
You are helping me run the "Commerce Product Visibility Audit" ecommerce operating play.
