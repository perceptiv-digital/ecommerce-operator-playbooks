...
summary: "Tracking Sanity Check helps ecommerce operators answer: Can we trust the tracking before making growth decisions?"
operating_question: "Can we trust the tracking before making growth decisions?"
short_title: "Tracking Sanity"
...
shopmcp_run_url: "https://my.shop-mcp.app/playbooks/ecom-tracking-sanity"
shopmcp_prompt: "Run the Tracking Sanity Check play for the last 30 days. Keep it read-only."
...
Can we trust the tracking before making growth decisions?
...
- Also useful for: Head of Ecommerce, Performance Marketer, Head of Marketing
- Best used when the owner needs a decision, not just a report.

## When To Run It

- Cadence: weekly
- Run it when the owner needs to decide: can we trust the numbers before making a decision?
...
1. Define the decision window and write the operating question: "Can we trust the tracking before making growth decisions?"
...
4. Compare commerce truth against analytics, ad, lifecycle, and UTM evidence. Stop when source drift makes the conclusion unsafe.
...
```text
You are helping me run the "Tracking Sanity Check" ecommerce operating play.
...
https://my.shop-mcp.app/playbooks/ecom-tracking-sanity?utm_source=github&utm_medium=playbook&utm_campaign=ecommerce_operator_os
