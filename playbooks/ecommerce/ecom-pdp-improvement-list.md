...
summary: "PDP Improvement List helps ecommerce operators answer: Which product pages should be improved first?"
operating_question: "Which product pages should be improved first?"
short_title: "PDP Improvement"
...
shopmcp_run_url: "https://my.shop-mcp.app/playbooks/ecom-pdp-improvement-list"
shopmcp_prompt: "Run the PDP Improvement List play for the last 30 days. Keep it read-only."
...
Which product pages should be improved first?
...
- Also useful for: Head of Ecommerce, Merchandising Manager
...
1. Define the decision window and write the operating question: "Which product pages should be improved first?"
...
```text
You are helping me run the "PDP Improvement List" ecommerce operating play.
