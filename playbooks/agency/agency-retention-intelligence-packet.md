...
shopmcp_run_url: "https://my.shop-mcp.app/playbooks/agency-retention-intelligence-packet"
...
What should the agency tell this client about retention risk and next actions?
...
- Also useful for: Agency AM / COO, Retention / Email Lead
...
- Attentive subscriber, journey, event, and deliverability readiness evidence where connected.
...
1. Define the decision window and write the operating question: "What should the agency tell this client about retention risk and next actions?"
...
```text
You are helping me run the "Retention Intelligence Packet" ecommerce operating play.
...
```text
Run the Retention Intelligence Packet play for the last 30 days. Keep it read-only.
```
