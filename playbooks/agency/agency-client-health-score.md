...
summary: "Agency Client Health Score helps ecommerce operators answer: Which client needs intervention before the next meeting?"
operating_question: "Which client needs intervention before the next meeting?"
short_title: "Agency Client Health Score"
...
shopmcp_run_url: "https://my.shop-mcp.app/playbooks/agency-client-health-score"
shopmcp_prompt: "Run the Agency Client Health Score play for the last 30 days. Keep it read-only."
...
Which client needs intervention before the next meeting?

This play helps agency am / coo make a defensible ecommerce operating decision. It is not a generic prompt. It is a repeatable workflow that forces evidence, thresholds, and vetoes before action.

## Who Should Run It

- Primary owner: Agency AM / COO
- Also useful for: Agency AM / COO
- Best used when the owner needs a decision, not just a report.

## When To Run It

- Cadence: weekly
- Run it when the owner needs to decide: which client needs attention before the next meeting?
...
1. Define the decision window and write the operating question: "Which client needs intervention before the next meeting?"
...
4. Convert client evidence into AM-ready notes, separating actual intervention needs from missing-data noise.
...
```text
You are helping me run the "Agency Client Health Score" ecommerce operating play.
...
```text
Run the Agency Client Health Score play for the last 30 days. Keep it read-only.
```
