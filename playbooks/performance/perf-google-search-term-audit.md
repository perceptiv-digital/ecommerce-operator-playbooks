...
Which search terms are wasting spend or cannibalising intent?
...
1. Define the decision window and write the operating question: "Which search terms are wasting spend or cannibalising intent?"
...
```text
You are helping me run the "Google Ads Search-Term Audit" ecommerce operating play.
