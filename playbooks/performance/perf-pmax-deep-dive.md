...
Is Performance Max scaling profitably or hiding waste?
...
1. Define the decision window and write the operating question: "Is Performance Max scaling profitably or hiding waste?"
...
```text
You are helping me run the "Performance Max Deep Dive" ecommerce operating play.
