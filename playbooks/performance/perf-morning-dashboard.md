...
What needs attention in paid media this morning?
...
- Also useful for: Performance Marketer
...
1. Define the decision window and write the operating question: "What needs attention in paid media this morning?"
...
```text
You are helping me run the "Performance Morning Dashboard" ecommerce operating play.
...
```text
Run the Performance Morning Dashboard play for the last 30 days. Keep it read-only.
```
