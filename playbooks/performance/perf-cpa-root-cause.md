...
Why did CPA spike and what should be checked first?
...
1. Define the decision window and write the operating question: "Why did CPA spike and what should be checked first?"
...
```text
You are helping me run the "CPA Spike Root Cause Explainer" ecommerce operating play.
